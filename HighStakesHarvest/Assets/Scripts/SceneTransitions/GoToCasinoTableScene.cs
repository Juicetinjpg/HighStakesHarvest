...
public class GoToCasinoTableScene : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("GoToCasinoTableScene: No Button component found on this GameObject.");
        }
    }
    ...
    void OnButtonClick()
    {
        ...
        if (fadePrefab != null)
        {
            ...
            if (fadeCanvasGroup != null)
                ...
                SceneManager.LoadScene("CasinoTable");
        }
        else
        {
